...
const eliminarFavo = async(req, res)=>{
    ...
    try {
            ...
            usuario.favoritos = usuario.favoritos.filter((el) => el._id.toString() != borra)
    
            await usuario.save()
    
            res.status(200).json({
                message: "Favorito eliminado correctamente", 
                usuario: usuario.favoritos
            })
